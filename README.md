...
The current release is [Markdex v1.0.2](https://github.com/DiulioAires/markdex/releases/tag/v1.0.2).
Windows users can install it with either the [NSIS installer](https://github.com/DiulioAires/markdex/releases/download/v1.0.2/Markdex_1.0.2_x64-setup.exe)
or the [MSI package](https://github.com/DiulioAires/markdex/releases/download/v1.0.2/Markdex_1.0.2_x64_en-US.msi).
